...
from agloviz.config.models import TimingMode
from agloviz.core.director import Director
from agloviz.core.scene import SceneEngine
from agloviz.core.storyboard import Act, Beat, Shot
...
class TestTimingIntegration:
    ...
    def test_voiceover_timing_integration(self):
        ...
        beat = Beat(
            action="show_title", args={"text": "Test"}, narration="Test narration"
        )
        director._run_beat(beat, 0, 0, 0)
    ...
    def test_beat_timing_calculation(self):
        ...
        beat_with_min = Beat(
            action="show_title", args={"text": "Test"}, min_duration=2.0
        )
