...
class TestTimingParameterResolution:
    ...
    def test_resolve_simple_timing_path(self) -> None:
        """Test resolving simple timing configuration paths."""
        timing_config = {"ui": 1.0, "events": 0.8, "effects": 0.5, "waits": 0.5}
    ...
    def test_resolve_timing_path_with_pydantic_model(self) -> None:
        """Test resolving timing paths with Pydantic TimingConfig model."""
        timing_config = TimingConfig(
            mode=TimingMode.NORMAL, ui=1.0, events=0.8, effects=0.5, waits=0.5
        )
    ...
    def test_resolve_timing_path_with_context(self) -> None:
        """Test resolving timing paths using ResolverContext."""
        timing_config = {"ui": 1.5, "events": 1.2, "effects": 0.8}
    ...
    def test_resolve_timing_path_without_context(self) -> None:
    ...
    def test_resolve_timing_path_missing_keys(self) -> None:
        """Test resolving missing timing configuration keys."""
        timing_config = {"ui": 1.0, "events": 0.8}
    ...
    def test_resolve_timing_path_with_omega_conf_templates(self) -> None:
        """Test resolving timing paths with OmegaConf template syntax."""
        timing_config = {"ui": 1.0, "events": 0.8, "effects": 0.5}
    ...
    def test_resolve_timing_path_error_handling(self) -> None:
    ...
    def test_resolve_timing_path_with_different_modes(self) -> None:
        """Test resolving timing paths with different timing modes."""
        # Test with different timing modes
        draft_timing = TimingConfig(
            mode=TimingMode.DRAFT, ui=0.5, events=0.4, effects=0.25, waits=0.25
        )
        normal_timing = TimingConfig(
            mode=TimingMode.NORMAL, ui=1.0, events=0.8, effects=0.5, waits=0.5
        )
        fast_timing = TimingConfig(
    ...
    def test_resolve_complex_timing_structure(self) -> None:
        ...
        timing_config = {
            ...
            "custom_timings": {"animation": 1.2, "transition": 0.3, "highlight": 0.8},
        }
    ...
    def test_resolve_timing_path_with_numeric_values(self) -> None:
